    ...
    <div className="space-y-5">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-[#e1e6f0] bg-white p-8 shadow-sm sm:p-12">
        ...
        <div className="relative max-w-2xl">
          ...
          <h2 className="mt-6 text-4xl font-bold leading-[1.12] tracking-tight text-slate-900 sm:text-5xl">
            What does it mean{" "}
            <span className="text-amber-700">to live well?</span>
          </h2>

          <p className="mt-5 text-[15px] leading-relaxed text-slate-700 max-w-xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURED_CHAPTERS.map(({ slug, title, description }) => (
            ...
            >
              ...
              <p className="mt-4 text-xs font-semibold text-amber-700/70 group-hover:text-amber-700 transition-colors">
                Read chapter →
              </p>
            </Link>
          ))}
      ...
      {/* CTA */}
      <section className="rounded-2xl border border-amber-400/30 bg-amber-50 p-8 text-center">
        <p className="text-lg font-bold text-slate-900">
          Ready to examine how you live?
        </p>
        <p className="mt-2 max-w-md mx-auto text-sm leading-relaxed text-slate-600">
